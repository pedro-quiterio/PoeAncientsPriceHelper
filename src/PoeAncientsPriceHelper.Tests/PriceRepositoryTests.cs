...
public class PriceRepositoryTests
{
    ...
    // A response missing the `core` block (e.g. an API change or network truncation) should
    // not throw — it degrades to showing zero prices rather than crashing.
    [Fact]
    public async Task MissingCoreBlock_DoesNotThrow()
    {
        const string response = """
            {
